...
class Adnd2eOracleBriefing
{
    ...
    public static function markdown(): string
    {
        ...
        $lines = [
            ...
            '- Psionicist is a class (aliases: Psion, Psionic, Psionics). Combat figures use the rogue group. PSP totals and powers are not simulated. Do not invent 5th Edition psionics.',
            '',
            '### Advancement and the kit field',
            '- Single-class: one class. Multi-class: classes advance together; combined THAC0 is the best (lowest); saves take the best (lowest) per category. Dual-class: typically human; original class first, current class second.',
            '- Kit / specialist is one free-text field. Suggestions are names only, filtered by race and required class(es). Specialist schools ('.$schools.') appear for Mages. A Psionicist may store a discipline name as the kit (labels only). Racial-handbook kit names (for example Bladesinger) appear only when race and class path match — Bladesinger is Elf + Fighter/Mage, not a generic Mage/wizard-handbook kit. Do not invent kit benefit tables.',
